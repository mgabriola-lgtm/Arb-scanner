...
.btn-g{background:var(--g);color:#000;border:none;padding:8px 14px;border-radius:5px;font-family:monospace;font-size:11px;font-weight:700;letter-spacing:1px;cursor:pointer;white-space:nowrap;align-self:flex-end}
.btn-g:disabled{opacity:.5}
.btn-o{background:transparent;color:#444;border:1px solid var(--b2);padding:8px 12px;border-radius:5px;font-family:monospace;font-size:11px;letter-spacing:1px;cursor:pointer;white-space:nowrap;align-self:flex-end;transition:all .15s}
...
.fbtn{background:var(--s1);border:1px solid var(--b);color:#333;padding:5px 10px;border-radius:4px;font-family:monospace;font-size:9px;letter-spacing:1px;cursor:pointer;white-space:nowrap}
.fbtn.a{border-color:var(--g);color:var(--g);background:rgba(0,255,136,.05)}
.sortsel{margin-left:auto;background:var(--s1);border:1px solid var(--b);color:var(--tx);padding:5px 8px;border-radius:4px;font-family:monospace;font-size:9px;cursor:pointer;color-scheme:dark;outline:none}
...
.pval.g{color:var(--g)}
.copybtn{background:transparent;border:1px solid var(--b2);color:#333;padding:5px 10px;border-radius:4px;font-family:monospace;font-size:9px;letter-spacing:1px;cursor:pointer;white-space:nowrap;transition:all .15s}
...
<div class="wrap">
  ...
  <div id="out">
    <div class="center">
      ...
      <div class="empty-sub">Paste your API key from the-odds-api.com, pick a sport, hit SCAN.</div>
    </div>
  </div>
</div>
<script>
